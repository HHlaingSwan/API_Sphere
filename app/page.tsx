...
import { ArrowRight, Sparkles, Code, GitFork, Radio, Cpu, Layers, Terminal, FileText, Video } from "lucide-react";
...
const apiTypes = [
  {
    name: "REST",
    description: "The classic architectural style of the web. Resource-oriented, stateless, and standard-bound.",
    tag: "Traditional",
  ...
  {
    name: "GraphQL",
    description: "Ask for what you need and get exactly that. Consolidate your requests into a single roundtrip.",
    tag: "Query-driven",
  ...
  {
    name: "Webhooks",
    description: "Don't call us, we'll call you. Reorganize your architectures with event-driven HTTP callbacks.",
    tag: "Event-Driven",
  ...
  {
    name: "WebSockets",
    description: "Establish a permanent, full-duplex TCP tunnel. Ideal for real-time dashboards and chat systems.",
    tag: "Real-time",
  ...
  {
    name: "gRPC",
    description: "Google's high-performance remote procedure call framework powered by Protobuf serialization.",
    tag: "High-Perf RPC",
    color: "from-violet-500/20 to-indigo-500/10 text-violet-400 border-violet-500/20",
    icon: Terminal,
    slug: "grpc",
  },
  {
    name: "MCP",
    description: "Model Context Protocol. An open-standard enabling LLMs and AI Agents to securely interact with local tools.",
    tag: "AI / Agentic",
    color: "from-fuchsia-500/20 to-purple-500/10 text-fuchsia-400 border-fuchsia-500/20",
    icon: Cpu,
    slug: "mcp",
  },
  {
    name: "SOAP",
    description: "Enterprise-grade XML messaging with strict WSDL contracts, WS-Security, and transactional integrity.",
    tag: "Enterprise",
    color: "from-yellow-500/20 to-amber-500/10 text-yellow-400 border-yellow-500/20",
    icon: FileText,
    slug: "soap",
  },
  {
    name: "WebRTC",
    description: "Peer-to-peer audio, video, and data transfer with sub-500ms latency for real-time communications.",
    tag: "Peer-to-Peer",
  ...
  return (
    <div className="relative min-h-screen flex flex-col bg-background font-sans text-foreground overflow-hidden">
      ...
      <section className="relative pt-24 pb-20 sm:pt-32 sm:pb-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto flex flex-col items-center text-center">
        ...
        >
          An interactive catalog and testing sandbox comparing REST, SOAP, GraphQL, Webhooks, WebSockets, gRPC, WebRTC, and MCP. Choose the right interface for your next application.
        </motion.p>
        ...
        <div className="relative w-full max-w-3xl h-16 mt-16 flex flex-wrap justify-center items-center gap-3 md:gap-5">
          {["REST", "SOAP", "GraphQL", "tRPC", "Webhooks", "SSE", "WebSockets", "WebRTC", "gRPC", "MCP"].map((p, idx) => (
            <motion.div
              key={p}
      ...
      <section className="py-20 border-t border-border bg-background/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl font-bold tracking-tight text-foreground sm:text-4xl">The API Catalog</h2>
            <p className="mt-4 text-sm sm:text-base text-muted-foreground">
              A breakdown of the core communication models driving digital interfaces today.
            </p>
          </div>
                ...
                >
                  <div>
                    ...
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <span className={`text-[10px] uppercase tracking-wider font-bold px-2 py-0.5 rounded-full border ${api.color}`}>
                        {api.tag}
                      </span>
                    </div>

                    <h3 className="text-lg font-bold text-foreground mb-2">{api.name}</h3>
                    <p className="text-xs text-muted-foreground leading-relaxed mb-6">{api.description}</p>
                  </div>
      ...
      <section className="py-20 border-t border-border bg-muted/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center mb-12">
            <h2 className="text-3xl font-bold tracking-tight text-foreground sm:text-4xl">Flow Visualizer</h2>
            <p className="mt-4 text-sm sm:text-base text-muted-foreground">
              Interactive playground simulating how request packages travel across network borders.
            </p>
          </div>
      ...
      <section id="comparison-matrix" className="py-20 border-t border-border bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center mb-12">
            <h2 className="text-3xl font-bold tracking-tight text-foreground sm:text-4xl">Protocol Matrix</h2>
            <p className="mt-4 text-sm sm:text-base text-muted-foreground">
              Compare architectural styles, transport levels, payloads, and capabilities in a consolidated grid.
            </p>
          </div>
      ...
      <section id="http-status-codes" className="py-20 border-t border-border bg-muted/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center mb-12">
            ...
            <p className="mt-4 text-sm sm:text-base text-muted-foreground">
              Make live API calls to a real REST endpoint and inspect actual HTTP responses — status codes, headers, and body.
            </p>
          </div>
      ...
      <footer className="mt-auto border-t border-border bg-background py-12 text-center text-xs text-muted-foreground">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row justify-between items-center gap-4">
          <div className="flex items-center gap-2">
            <div className="h-6 w-6 rounded bg-gradient-to-tr from-violet-600 to-cyan-500 flex items-center justify-center text-white text-[10px] font-bold">
              AS
            </div>
            <span className="font-semibold text-muted-foreground">APISphere</span>
          </div>
          <p>© {new Date().getFullYear()} APISphere. All rights reserved. Built with Next.js & Tailwind CSS.</p>
